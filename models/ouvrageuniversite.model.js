...
const ouvrageUniversiteSchema = new Schema({
    ...
    faculteOuvrage: {type: String, required: true},     
},{timestamps: true, versionKey: false });

module.exports.OuvrageUniversite = model('OuvrageUniversite', ouvrageUniversiteSchema);